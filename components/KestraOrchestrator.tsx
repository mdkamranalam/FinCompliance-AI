...
const KestraOrchestrator: React.FC<KestraOrchestratorProps> = ({ currentStep }) => {
  ...
  return (
    <div className="w-full bg-secondary/50 border border-slate-700 rounded-xl p-6 mb-6 shadow-sm">
      ...
      <div className="overflow-x-auto pb-2 -mx-6 px-6 md:overflow-visible md:pb-0 md:px-0 scrollbar-hide">
        <div className="relative min-w-[320px] mx-2 md:mx-6">
          ...
          <div className="flex justify-between items-start">
            {steps.map((step) => {
              ...
              return (
                <div key={step.id} className="flex flex-col items-center gap-3 relative z-10 group cursor-default min-w-[60px]">
                  <div 
                    className={`
